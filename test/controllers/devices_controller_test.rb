...
describe API::DevicesController do
  ...
  #     post schedule_url, params: { device_id: id, device_token: 'token' }
  #
  ...
  #
  #     post schedule_url, params: { device_id: id, device_token: device.device_token }
  #
  #     assert_response :success
  #     assert_equal 1, Device.count
  #   end
  ...
  #
  #     post schedule_url, params: { device_id: id, device_token: 'new-token' }
  #
  #     assert_response :success
  ...
  #     Fabricate(:device, device_id: id)
  #
  #     post schedule_url, params: { device_id: id, device_token: nil }
  #
  #     assert_response :success
  ...
  #     device = Fabricate(:device, device_id: id)
  #
  #     post schedule_url, params: { device_id: nil, device_token: device.device_token }
  #
  #     assert_response 422
  #   end
  # end
  ...
  #   it 'creates a new device if one does not exist with given device_id' do
  #     id = SecureRandom.uuid
  #     post schedule_url, params: { device_id: id, schedule: [] }
  #
  #     assert_response :success
  #     assert_equal 1, Device.count
  #   end
  ...
  #     post schedule_url, params: { device_id: device.id, schedule: ['id'] }
  #
  #     assert_response :success
