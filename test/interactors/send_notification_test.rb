...
describe SendNotification do
  it 'opens connection to houston connection, creates notification for each device and writes, closes connection' do
    ...
    connection = lambda { |uri, certificate, passphrase|
